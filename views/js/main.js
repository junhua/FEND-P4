...
var resizePizzas = function(size) { 
  ...
  // UPDATE: brings out all var declarations out of the for loop
  function changePizzaSizes(size) {
    ...
    for (var i = 0, len = rpc.lengh; i < len; i++) {
...
function updatePositions() {
  ...
  var phasesin = (document.body.scrollTop / 1250);
  var phase;
  for (var i = 0, len=items.length; i < len; i++) {
    phase = Math.sin(phasesin + (i % 5));
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0, rc = cols*rows; i < rc; i++) {
