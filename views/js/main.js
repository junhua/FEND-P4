...
function updatePositions() {
    ...
    for (var e, a = document.getElementsByClassName("mover"), r = a.length, n = document.body.scrollTop / 1250, i = 0; r > i; i++) e = Math.sin(n + i % 5), a[i].style.left = a[i].basicLeft + 100 * e + "px";
...
var adjectives = ["dark", "color", "whimsical", "shiny", "noise", "apocalyptic", "insulting", "praise", "scientific"],
    ...
    resizePizzas = function(e) {
        ...
        function n(e) {
            for (var a = document.getElementsByClassName("randomPizzaContainer"), n = r(a[0], e), i = a[0].offsetWidth + n + "px", t = 0; t < a.length; t++) a[t].style.width = i
        }
...
window.addEventListener("scroll", updatePositions), document.addEventListener("DOMContentLoaded", function() {
    for (var e = 8, a = 256, r = window.screen.height / 100, n = document.getElementById("movingPizzas1"), i = 0; e * r > i; i++) {
        var t = document.createElement("img");
        t.className = "mover", t.src = "images/pizza.png", t.style.height = "100px", t.style.width = "73.333px", t.basicLeft = i % e * a, t.style.top = Math.floor(i / e) * a + "px", n.appendChild(t)
    }
    updatePositions()
});